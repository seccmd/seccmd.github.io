...
如果你做的事情和其他人一样，很难集中人才，很难让人们真正相信一个使命。如果你在做一件独一无二的事情，你就有了一个真正好的顺风。
...
我认为做到这一点无论如何都很难，就像你通常比我们得到的时间更长来扩展一个新公司的基础设施。但你知道有很多人想要帮助。

**主持人：** 嗯，你们一直在做的工作令人难以置信。我们看到像O3和O4 mini这样的推理模型与像4o这样的多模态模型并行发展。当这两个线程汇聚时会发生什么，GPT-5及以后的愿景是什么？

**Sam Altman：** 我的意思是我们不会在GPT-5上完全实现，但最终我们确实想要一个集成模型，可以在需要时推理，在需要时生成实时视频。

如果你问一个问题，你可以想象它非常努力地思考，做一些研究，编写一堆代码，及时为你创建一个全新的应用程序，或者渲染你可以交互的实时视频。

所以我认为这会感觉像一个真正新型的计算机界面，AI在某种程度上已经做到了，但当我们得到一个具有真正完整多模态性的模型时，如完美的视频、完美的编码、一切和深度推理，这会感觉相当强大。

**主持人：** 看起来这可能是向体现方面的跳跃，你知道拥有视觉、语音和推理是向机器人的跳跃。

**Sam Altman：** 我们想要我们的策略是首先掌握这一点，然后确保我们可以将其连接到机器人。但机器人的时代很快就要到来。我认为我对这样一个世界非常兴奋：当你注册ChatGPT订阅的最高级别时，我们也会给你免费寄送一个人形机器人。我的意思是，那个未来将会非常疯狂。

能够拥有在现实世界中做真正工作的机器人，我认为我们现在离这个目标不远了。机器人的机械工程一直很困难，认知部分的AI也很困难，但感觉触手可及。

我认为在几年内，机器人将开始做超级有用的事情。制造十亿个机器人仍然需要一段时间，但我不知道，我对这个问题很感兴趣：你需要多少机器人来完全自动化供应链？比如如果你用传统方式制造一百万个人形机器人，它们能运行整个供应链，驾驶采矿设备，驾驶集装箱船，运行铸造厂并制造新机器人吗？

然后也许你实际上可以快速在世界上获得很多机器人，但世界对人类机器人的需求将远远超过我们目前供应链所能想到的。

**主持人：** 我想当你坐在我的位置时，你主导的事情之一是在YC对硬科技的更多投资。坐在我们现在的地缘政治位置，我们需要做什么来确保美国实际上能够拥有制造业和工业能力？你知道，我们甚至不能制造精密螺丝和大型钣金而不产生疯狂的成本超支。我们能做什么来确保这种情况在这里发生？

**Sam Altman：** 有所有这些人们一直抛出的答案，一段时间以来一直抛出同样的东西，显然没有奏效。所以我认为所有的政策都值得尝试，但我的直觉是我们需要尝试新的东西，我们不应该继续尝试同样失败的东西。

你知道，AI和机器人确实给我们一个新的可能性，以一种真正重要的新方式将制造业带回这里，将这些复杂的产业带回这里，我会说这至少值得尝试。

**主持人：** 是的，在这里防御性看起来像什么？你知道经典问题之一是，你知道我如何创办一个不会被OpenAI碾压的初创公司，这是我们聊天中的第一个问题。

**Sam Altman：** 我们不想碾压你。看，我们要做我们的事情，希望做得很好。我们要尝试从ChatGPT中制作最好的超级助手，我们要添加我们认为需要添加的东西。

但这只是我们面前机会的一小部分，当人们说我要创办一个新的初创公司，我要制作ChatGPT的一个版本时，这让我们感到难过，因为我们认为我们会做得很好，我们有一个相当大的领先优势。

但还有很多空间可以追求，有很多令人难以置信的其他公司使用我们的平台建立起来。我们希望让你们所有人更容易，我们希望做更多的事情，比如现在你可以想象ChatGPT可以为新的初创公司带来很多流量，我们可以在ChatGPT内部做一种新型的应用程序或代理或任何你想称之为商店的东西，为新的初创公司带来流量来帮助。

你可以想象我们可以做一个用OpenAI登录，人们可以带着他们的个性化模型，轻松连接到新的初创公司，这可能在很多方面都会有帮助。所以我们想成为其他人建造东西的平台。

我们的建议是不要建造我们的核心聊天助手。但还有另一个问题，这对我见过的每种创业历史时刻都是一样的，人们同时对同样的事情感到兴奋。

所以与其去建造你想到的每个人都在做的事情，我们是非常社会化的生物，我们受到其他人正在做的事情的很大影响。

我打赌如果Gary列出他最常听到的人们想用AI建造的五个想法，房间里一半的人会为其中一个举手。希望在这个房间里有一天会创办一家比OpenAI大得多的公司的人，我敢打赌那个人不在这五个中的任何一个上工作。

所以如果其他人都试图做同样的事情，很难建立可防御的东西。有时候它会奏效，这不是不可能的，但最好的、最持久的公司通常不会做与其他人相同的事情。

这给你时间在你必须回答防御性问题之前弄清楚什么是伟大的产品，如何建造技术。我们花了很长时间才弄清楚如何回答ChatGPT的防御性问题。

我们建造了这个东西，很长一段时间唯一的防御性是我们在市场上有唯一的产品。然后我们开始有一个开始知名的品牌。现在我们有记忆和连接以及一大堆其他真正可防御的东西。

但你知道，在很长一段时间里，这对我们来说是一个公平的批评，我们没有任何防御性策略，我们只是有市场上唯一好的东西。然后你有一些窗口，在此之前你必须建立防御性。

**主持人：** 我们过去谈论过的一件事是我们都是Peter Thiel的忠实追随者，他谈论了很多关于逆向思维但正确的问题。

**Sam Altman：** 我认为Peter是个天才，绝对是。

**主持人：** 你以真正根本的方式逆向思维。我的意思是回到对话的开始，人们认为哦，扩展定律有价值的想法，今天它被视为基本真理，但不是很多年前，它与基本事实完全相反。

当你得到那种推回时，你和你的团队感受到什么？你说你知道，我不会做你告诉我的事情，你知道我要推回，得到推回意味着这是一个逆向思维的领域，我们要在这里下注，我们要是对的？

**Sam Altman：** 面对很多其他人告诉你你错了时保持信念是很困难的，我认为说这很容易的人不诚实。随着时间的推移会变得更容易，但就像我记得有一次我可以说这个，因为它被公开了，在OpenAI早期不是早期，几年后，Elon给我们发了一封真的很刻薄的邮件。
...
**主持人：** 也许你可以邀请我有时做一个关于你可以随着时间建立的防御性领域的演讲，因为我认为这是人们的内在问题，他们说"哦好的，你知道我是一家SaaS公司，将会有及时软件。"我认为问题背后的问题是"什么是实际的防御性策略？"所以有一天那会是一个有趣的演讲。
...
**主持人：** 看，有很多。你知道在10或20年内，除非出现严重错误，我们将拥有难以想象的超级智能。我非常兴奋看到那会如何发展。
...
**Sam Altman：** 你知道有趣的是你提起这个，我几天前刚刚挖出了那封电子邮件，因为我感觉我随着时间被错误引用了，我很好奇。
