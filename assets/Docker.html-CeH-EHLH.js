import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as e,f as a,o as i}from"./app-Da1vT5-m.js";const l={};function p(r,s){return i(),e("div",null,[...s[0]||(s[0]=[a(`<h1 id="docker-国内安装解决方案" tabindex="-1"><a class="header-anchor" href="#docker-国内安装解决方案"><span>Docker 国内安装解决方案</span></a></h1><ul><li>支持Linux、Win、Mac</li><li><a href="https://github.com/tech-shrimp/docker_installer/releases" target="_blank" rel="noopener noreferrer">https://github.com/tech-shrimp/docker_installer/releases</a></li></ul><h2 id="windows" tabindex="-1"><a class="header-anchor" href="#windows"><span>Windows</span></a></h2><ul><li>任务栏搜索功能，启用&quot;适用于Linux的Windows子系统&quot; + &quot;虚拟机平台&quot;</li><li>管理员权限打开命令提示符，安装wsl2<br> wsl --set-default-version 2<br> wsl --update --web-download</li><li>下载Windows版本安装包，进入此项目的Release<br><a href="https://github.com/tech-shrimp/docker_installer/releases" target="_blank" rel="noopener noreferrer">https://github.com/tech-shrimp/docker_installer/releases</a></li></ul><h2 id="linux" tabindex="-1"><a class="header-anchor" href="#linux"><span>Linux</span></a></h2><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span># 一键安装命令（每天自动从官网定时同步）</span></span>
