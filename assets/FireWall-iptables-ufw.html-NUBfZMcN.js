import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,e,o as i}from"./app-CNbPg_2d.js";const l={};function p(t,s){return i(),a("div",null,[...s[0]||(s[0]=[e(`<h1 id="firewall配置全解-ufw、云主机nat及linux策略路由" tabindex="-1"><a class="header-anchor" href="#firewall配置全解-ufw、云主机nat及linux策略路由"><span>FireWall配置全解：UFW、云主机NAT及Linux策略路由</span></a></h1><h3 id="ufw" tabindex="-1"><a class="header-anchor" href="#ufw"><span>ufw</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>1. sudo apt-get install ufw</span></span>
